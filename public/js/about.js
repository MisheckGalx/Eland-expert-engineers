  ...
  mount.innerHTML = `
    <section class="about-section">
      ...
      <h1 class="section-title reveal reveal-delay-1"
          style="max-width:680px; margin-bottom:68px;">
      ...
      <div class="about-layout">
          ...
          <div class="about-visual-main">
            ...
            <div style="position:absolute;bottom:22px;left:22px;z-index:2;">
              <div style="font-size:9.5px;letter-spacing:0.22em;text-transform:uppercase;
                          color:var(--orange);margin-bottom:3px;font-weight:700;">
                Headquarters
              </div>
        ...
        <div class="about-content reveal reveal-delay-1">
          <p>
            Eland Expert Engineers (Pty) Ltd is a specialist electrical and instrumentation
            engineering company based in Randburg, South Africa. We are not simply a service
            provider — we are a strategic engineering partner for industrial clients who demand
            precision, performance, and complete accountability.
          </p>
          <p>
            Our multidisciplinary team brings deep expertise across power generation, water
            analytics, industrial automation, and instrumentation systems. From concept through
            commissioning and beyond, we deliver integrated solutions that eliminate the
            complexity of managing multiple engineering vendors.
          </p>
          <p>
            Our philosophy is simple: every system we engineer must deliver measurable
            performance improvement, operational reliability, and long-term value to our clients.
          </p>
          <div class="about-highlights">
            ...
            <div class="highlight"><div class="highlight-dot"></div><span>Multidisciplinary expertise across six core E&amp;E disciplines</span></div>
    ...
    <!-- Compliance & Safety dual panel -->
    <div class="compliance-panel">
      <div class="compliance-block">
        <div class="section-label reveal">Compliance</div>
        <h2 class="section-title reveal reveal-delay-1"
            style="font-size:clamp(24px,2.8vw,38px);">
          Full Regulatory<br>Compliance
        </h2>
        <p style="color:var(--text-light);font-size:14px;line-height:1.7;
                  font-weight:300;margin-top:10px;max-width:400px;" class="reveal reveal-delay-2">
          We manage every layer of legal, payroll, and insurance compliance so your project
          runs without risk.
        </p>
      ...
      <div class="compliance-block">
        ...
        <h2 class="section-title reveal reveal-delay-1"
            style="font-size:clamp(24px,2.8vw,38px);">
          Safety-First<br>Engineering Culture
        </h2>
        <p style="color:var(--text-light);font-size:14px;line-height:1.7;
                  font-weight:300;margin-top:10px;max-width:400px;" class="reveal reveal-delay-2">
          Every engineer deployed by Eland operates under industry-leading safety standards
    ...
    <div class="cta-banner" style="background-image:url('images/slider/slide-02.jpg')">
      ...
      <p class="reveal reveal-delay-1">
        Discover what a true single-source engineering partner can deliver for your operation.
      </p>
