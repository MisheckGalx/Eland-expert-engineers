...
(function buildProjects() {
  ...
  const projects = [
    { industry:'Water &amp; Wastewater', title:'Municipal SCADA Upgrade — Water Treatment Plant', desc:'Designed and commissioned a full SCADA replacement for a major municipal water treatment facility, integrating 40+ field instruments with a modern HMI control system.', metric:'40%', metricDesc:'reduction in manual operator interventions' },
    ...
    { industry:'Power Generation', title:'Obsolescence Migration — Boiler Control System', desc:'Phased replacement of a 5 year old obsolete boiler instrumentation and control system without full plant shutdown, protecting operational continuity.', metric:'Millions', metricDesc:'replacement cost avoided through phased migration' },
    { industry:'Industrial', title:'Labour Supply — Refinery Turnaround', desc:'Mobilised and managed a team of 3 qualified E&amp;I technicians for a major refinery planned maintenance turnaround over 6 weeks, with full compliance management.', metric:'3', metricDesc:'engineers deployed, 100% compliance record' },
  ];
