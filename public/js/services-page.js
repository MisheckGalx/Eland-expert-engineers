...
(function buildServicesPage() {
  ...
  const services = [
    ...
    {
      num: '03', icon: '⚙️',
      title: 'Industrial Automation &amp; E&amp;E Installation',
      desc: 'Full-scope electrical and instrumentation installation services integrated with automation systems for industrial facilities. Our teams execute complex E&amp;E works to specification, on schedule, and with meticulous quality control throughout every phase.',
    ...
    },
    {
      ...
      desc: 'Flexible deployment of qualified E&amp;E engineers, technicians, and artisans for short and long-term project requirements. All personnel are vetted, trained, and managed under our full compliance framework — zero administrative burden for your organisation.',
      tags: ['E&amp;E Technicians','Instrument Mechanics','Project Engineers','Site Supervisors','Commissioning Eng.'],
